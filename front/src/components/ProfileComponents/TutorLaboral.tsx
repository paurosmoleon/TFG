...
const TutorLaboral: React.FC<TutorLaboralProps> = ({
  form,
  handleChange,
  handleSave,
}) => (
      ...
      <div className="w-full overflow-x-auto bg-white shadow-lg rounded-2xl p-4">
        <table className="w-full text-left text-sm border-collapse">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-4 py-3 border-b border-gray-300 font-semibold">Becario</th>
              <th className="px-4 py-3 border-b border-gray-300 font-semibold">Enviar Mensaje</th>
              <th className="px-4 py-3 border-b border-gray-300 font-semibold">Tutor de prácticas</th>
              <th className="px-4 py-3 border-b border-gray-300 font-semibold">Enviar Mensaje</th>
            </tr>
          </thead>
          <tbody>
