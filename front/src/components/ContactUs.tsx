                ...
                <div className="mb-10">
                    ...
                    <div className="flex">
                        <div className="flex items-center mr-11">
                            ...
                            <label htmlFor="radio-group-1" class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="radio-group-2" class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
