...
import ASCIIText from '../StyleComponents/ASCIIText';
...
<div className="flex flex-col items-center sm:items-center sm:justify-center sm:gap-4">
  <Link
    to="/home"
    className="flex items-center mb-4 space-x-3 rtl:space-x-reverse"
  >
    <LogoSVG className="w-36 mb-5 sm:pb-0" />
    <span className="self-center text-2xl font-semibold whitespace-nowrap text-slate-900">
      eFCT
    </span>
  </Link>
  <ul className="flex flex-wrap justify-center w-full items-center mb-6 text-sm font-medium text-slate-900 sm:mb-0">
    <li>
      <Link
        to="/"
