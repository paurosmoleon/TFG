                      ...
                      <tr key={dia} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-2">
                          <textarea
                            ...
                            className={`w-full border ${
                              err.actividad ? "border-red-400" : "border-gray-400"
                            } rounded-lg px-2 py-1 focus:outline-none focus:ring-2 ${
                              err.actividad
                                ? "focus:ring-red-300"
                        ...
                        <td className="px-3 py-2">
                          <input
                            ...
                            step="0.5"
                            className={`w-full border ${
                              err.horas ? "border-red-400" : "border-gray-400"
                            } rounded-lg px-2 py-1 focus:outline-none focus:ring-2 ${
                              err.horas
                                ? "focus:ring-red-300"
                                : "focus:ring-indigo-200"
