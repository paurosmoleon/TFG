...
const Chats: React.FC = () => {
  ...
  //LISTA INICIAL PANTALLA COMPLETA
  if (!selectedChat) {
    return (
            ...
            >
              ...
              <Link to="/dashboard/perfil-chat" className="flex-shrink-0 mr-6">
                <img
                  src={chat.avatar}
                  alt={chat.name}
                  className="w-10 h-10 rounded-full cursor-pointer transform transition duration-200 hover:scale-110"
                />
              </Link>

              {/* Separador vertical entre avatar y SVG */}
              ...
              {/* Separador vertical entre SVG y mensaje */}
              <div className="h-6 border-r-2 border-gray-300 mx-6" />
    ...
    <div className="flex h-[calc(100vh-4rem)]">
      ...
      <div className="flex-1 flex flex-col bg-gray-100">
        ...
        <div className="flex-1 p-4 overflow-y-auto flex flex-col">
          ...
          <div className="max-w-[0%] mb-4 p-3 rounded-xl bg-green-100 self-end">
        ...
        <div className="flex items-center p-4 bg-white border-t border-gray-200">
          ...
          />
          <button className="px-4 py-2 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition cursor-pointer">
            Enviar
          </button>
        </div>
      </div>
