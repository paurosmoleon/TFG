    ...
    return (
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 w-full">
        ...
        <div className="flex items-center ml-auto space-x-6">
          <button className="font-medium text-[15px] border-none outline-none"><a href='javascript:void(0)'
            className="text-blue-700 hover:underline">Login</a></button>
          <button
            className="px-4 py-2 text-sm rounded-sm font-medium text-white border border-blue-600 bg-blue-600 hover:bg-blue-700">Sign
            up</button>
